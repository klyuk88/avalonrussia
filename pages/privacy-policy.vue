  ...
  <div style="padding: 100px 0;">
    <div class="container">
      <div>
        ...
        <h5 id="list-1"><b>1. Общие положения</b></h5>
        ...
        <p style="display: inline" id="fio">ООО "Мангата Марин"</p>
        &nbsp;(далее – Оператор).
        <ol>
          <li>
          ...
          <li>
            ...
            <p style="display: inline" id="name">avalonrussia.ru</p>
            .
          </li>
        </ol>
        <div class="row"></div>
        ...
        <div class="row mb-4">
          <div class="col">
            <h5 id="list-4"><b>4. Цели обработки персональных данных</b></h5>
            <ol>
              <li>
              ...
              <li>
                ...
                электронной почты&nbsp;
                <p style="display: inline" id="email">
                  pavlov@mangatamarine.ru
                </p>
        ...
        <div class="row mb-4">
          <div class="col">
            <h5 id="list-8"><b>8. Заключительные положения</b></h5>
            <ol>
              <li>
